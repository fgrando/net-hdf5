...
if (${HDF5_PACKAGE_NAME}_BUILD_JAVA)
  set (${HDF5_PACKAGE_NAME}_JAVA_INCLUDE_DIRS
      ${PACKAGE_PREFIX_DIR}/../../HDF5/lib/jarhdf5-1.10.9.jar
      ${PACKAGE_PREFIX_DIR}/../../HDF5/lib/slf4j-api-1.7.33.jar
      ${PACKAGE_PREFIX_DIR}/../../HDF5/lib/slf4j-nop-1.7.33.jar
  )
  set (${HDF5_PACKAGE_NAME}_JAVA_LIBRARY "${PACKAGE_PREFIX_DIR}/../../HDF5/lib")
...
set (${HDF5_PACKAGE_NAME}_SHARE_DIR "${PACKAGE_PREFIX_DIR}/../../HDF5/cmake")
set_and_check (${HDF5_PACKAGE_NAME}_BUILD_DIR "${PACKAGE_PREFIX_DIR}/../../HDF5")
...
if (${HDF5_PACKAGE_NAME}_BUILD_TOOLS)
  ...
  set_and_check (${HDF5_PACKAGE_NAME}_TOOLS_DIR "${PACKAGE_PREFIX_DIR}/../../HDF5/bin")
endif ()
...
if (NOT TARGET "hdf5")
  if (${HDF5_PACKAGE_NAME}_ENABLE_Z_LIB_SUPPORT AND ${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS)
    include (${PACKAGE_PREFIX_DIR}/../../HDF5/cmake/-targets.cmake)
  endif ()
  if (${HDF5_PACKAGE_NAME}_ENABLE_SZIP_SUPPORT AND ${HDF5_PACKAGE_NAME}_PACKAGE_EXTLIBS)
    include (${PACKAGE_PREFIX_DIR}/../../HDF5/cmake/-targets.cmake)
  endif ()
  include (${PACKAGE_PREFIX_DIR}/../../HDF5/cmake/hdf5-targets.cmake)
endif ()
